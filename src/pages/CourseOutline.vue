<template>
  <div id="app-course-outline">
    <div class="block">
      ...
      <div class="main">
        <div id="forum-list">
          <el-card class="box-card" v-for="(forum, index) in forumList" :key="index">
            <div class="box-card-tip" v-if="index == 0">
              <img src="../assets/img/精2.png" style="width: 46px; height: 52px">
            </div>
            <img class="forumImg"
            ...
            <div v-else class="addreply">
              <el-button class="addclick" style="float:left" round>+我来回答</el-button>
            </div>
            <div class="bottom">
              <span>{{forum.reply_num}}回答</span>
              <span>{{forum.view_num}}浏览</span>
              <span>
                <img src="../assets/img/点赞.png" class="likedImg" style="width: 20px; height: 20px">
                {{forum.liked_num}}
              </span>
            </div>
        ...
        <div class="forum-tip">
          <el-card class="tip-card">
            <div class="tip-card-title">
              <img src="../assets/img/星星.png" style="width: 50px; height: 50px;float: left">
              <span>优秀学员</span>
            </div>
  ...
  const forumList = [
    {
      ...
      content: "java初学者就可以用myeclipse或者eclipse，还有记事本。随着学习的深入，相信慢慢都会了解到也会从中找到最适合自己的那款开发工具。初学者的话不建议上来就用IDE开发工具，比如说Eclipse、MyEclipse、IntelliJ IDEA、netbean。但是也可以使用这些，不建议的原因不便于你了解JavaAPI，及相关的编译原理，编译过程之类的。主要是就是熟悉基础。",
      reply_num: "4",
      view_num: "155",
      liked_num: "48",
      time: "2022-03-18",
      ...
      content: "配置java环境变量的方法：1、右键点击【计算机】，选择【属性】，点击【高级系统设置】，打开环境变量设置；2、新建【JAVA_HOME】变量，并编辑【Path】变量；3、新建【Classpath】变量并编辑即可。",
      reply_num: "2",
      view_num: "55",
      liked_num: "8",
      time: "2022-02-01",
      ...
      contentif: true,
      head_content: "最新回答 / 一起看日出吗",
      content: "继承：一般类只能单继承，内部类实现多继承，接口可以多继承封装：将类的某些信息隐藏在类内部，不允许外部程序直接访问，而是通过该类提供的方法来实现对隐藏信息的操作和访问。访问权限控制public > protected > 包 > private 内部类也是一种封装多态：编译时多态，体现在向上转型和向下转型，通过引用类型判断调用哪个方法（静态分派）。运行时多态，体现在同名函数通过不同参数实现多种方法（动态分派）。",
      reply_num: "1",
      view_num: "32",
      liked_num: "12",
      time: "2021-12-27",
